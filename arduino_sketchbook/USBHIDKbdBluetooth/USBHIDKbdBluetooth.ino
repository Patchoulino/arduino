...
#ifdef _DEBUG
   #define DEBUG_PRINT(str) mySerial.print (str)
   #define DEBUG_PRINTF(str, format) mySerial.print (str, format)
   #define DEBUG_PRINTLN(str)  mySerial.println (str)
#else
...
//    DEBUG_PRINTLN("Kbd");
    ...
    mySerial.write((uint8_t)0xFD); // BT-HID: Start Byte
    // mySerial.write((uint8_t)0x09); // BT-HID: Data Length
    mySerial.write((uint8_t)len+1); // BT-HID: Data Length
    mySerial.write((uint8_t)0x01); // BT-HID: Descriptor (1=Keyboard, 2=Mouse, 3=KybdMouse combo)
...
//    DEBUG_PRINTLN("Mouse");
    mySerial.write((uint8_t)0xFD); // BT-HID: Start Byte
    mySerial.write((uint8_t)0x05); // BT-HID: Data Length
    // mySerial.write((uint8_t)len+1); // BT-HID: Data Length
    mySerial.write((uint8_t)0x02); // BT-HID: Descriptor (1=Keyboard, 2=Mouse, 3=KybdMouse combo)
